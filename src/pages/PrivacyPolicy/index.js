            ...
            <section className={classes.privacyPolicy}>
                <div>
                    ...
                    <p className={classes.main_paragraph}>
                        Owner and Data Controller Name: <b>TraceLyfe</b>.  Address: <b>Gurgaon , sector 38 SAS tower , 9th floor</b>.
                    </p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <ul className={classes.main_paragraph}>
                        ...
                        <li>In any case, the Owner will gladly help to clarify the specific legal basis that applies to the processing, and in particular whether the provision of Personal Data is a statutory or contractual requirement, or a requirement necessary to enter into a contract.
                        </li>
                    </ul>
                    <p className={classes.main_paragraph}>
